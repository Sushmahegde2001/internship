...
st.write('The current R&D cost is ', rnd_cost)

Administration_cost = st.sidebar.number_input('Insert Administration cost Spend')
st.write('The current Administration cost is ', Administration_cost)

Marketing_cost_Spend = st.sidebar.number_input('Insert Marketing cost Spend')
st.write('The current Marketing cost is ', Marketing_cost_Spend)
